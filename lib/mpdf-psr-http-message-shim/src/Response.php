...
namespace RarWowVendor\Mpdf\PsrHttpMessageShim;

use RarWowVendor\Psr\Http\Message\StreamInterface;
 ...
 */
class Response implements \RarWowVendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \RarWowVendor\Psr\Http\Message\StreamInterface */
	private $stream;
