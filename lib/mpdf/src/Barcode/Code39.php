 ...
 */
class Code39 extends \RarWowVendor\Mpdf\Barcode\AbstractBarcode implements \RarWowVendor\Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $printRatio, $extended, $checksum)
	{
		...
		if ($code === false) {
			throw new \RarWowVendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid CODE39 barcode value "%s"', $code));
		}
