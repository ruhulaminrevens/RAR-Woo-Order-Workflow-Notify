 ...
 */
class EanExt extends \RarWowVendor\Mpdf\Barcode\AbstractBarcode implements \RarWowVendor\Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $length = 5)
	{
		...
		if ($length == 2) {
			...
			throw new \RarWowVendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid EAN barcode value "%s"', $code));
		}
