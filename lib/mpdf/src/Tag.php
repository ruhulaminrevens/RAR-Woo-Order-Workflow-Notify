...
class Tag
{
	...
	/**
	 * @param \RarWowVendor\Mpdf\Mpdf $mpdf
	 * @param \RarWowVendor\Mpdf\Cache $cache
	 * @param \RarWowVendor\Mpdf\CssManager $cssManager
	 * @param \RarWowVendor\Mpdf\Form $form
	 * @param \RarWowVendor\Mpdf\Otl $otl
	 * @param \RarWowVendor\Mpdf\TableOfContents $tableOfContents
	 * @param \RarWowVendor\Mpdf\SizeConverter $sizeConverter
	 * @param \RarWowVendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \RarWowVendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \RarWowVendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \RarWowVendor\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'RarWowVendor\Mpdf\Tag\\';
