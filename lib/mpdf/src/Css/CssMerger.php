...
namespace RarWowVendor\Mpdf\Css;

use RarWowVendor\Mpdf\Color\ColorConverter;
use RarWowVendor\Mpdf\CssManager;
use RarWowVendor\Mpdf\Exception\InvalidArgumentException;
...
class CssMerger
{
	...
	/**
	 * @var \RarWowVendor\Mpdf\Css\NormalizeProperties
	 */
	private $normalizeProperties;

	/**
	 * @var \RarWowVendor\Mpdf\Css\InlineStyleParser
	 */
	private $inlineStyleParser;

	/**
	 * @var \RarWowVendor\Mpdf\Css\SelectorParser
	 */
	private $selectorParser;

	/**
	 * @var \RarWowVendor\Mpdf\Css\InlinePropertyConverter
	 */
	...
	/**
	 * @var \RarWowVendor\Mpdf\Css\BorderMerger
	 */
