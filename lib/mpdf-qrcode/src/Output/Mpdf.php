...
namespace RarWowVendor\Mpdf\QrCode\Output;

use RarWowVendor\Mpdf\Mpdf as MpdfObject;
use RarWowVendor\Mpdf\QrCode\QrCode;
...
class Mpdf
{
	 ...
	 *
	 * @param \RarWowVendor\Mpdf\QrCode\QrCode $qrCode QR code instance
	 * @param \RarWowVendor\Mpdf\Mpdf $mpdf Mpdf instance
